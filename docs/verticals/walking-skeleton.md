...
The agent-facing documents, skills and hooks belong to the separate
[`agent-harness`](agent-harness.md) vertical. Presets install it immediately
after this skeleton; `keel new --no-agent-harness` leaves the runnable
project and its formatter configuration intact.
